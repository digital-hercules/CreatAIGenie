...
public class Languages {
    ...
    private static String[] tone = {"Normal","Friendly","Formal","Casual","Professional","Informative","Persuasive","Encouraging","Caring","Direct","Excited","Authoritative","Humorous"};
    private static String[] writingStyle = {};
