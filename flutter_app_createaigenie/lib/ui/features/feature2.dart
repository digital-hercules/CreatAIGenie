              ...
              children: [
                Column(
                  children: [
                    ...
                    AppSpacer.p20(),
                    SvgPicture.asset('assets/images/feature2.svg',height: context.height*0.3,fit: BoxFit.fitHeight,),
                    AppSpacer.p20(),
                    Text(
                      'Generate striking visuals, engaging videos, persuasive text, expert voiceovers, and distinct music effortlessly using our feature like, Artsy.AI, Text to Speech and AI Bot text generator ',
